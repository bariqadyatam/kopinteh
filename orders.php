...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Pesananku || Kopi N Teh Lossless</title>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      ...
      <!-- Right Nav Section -->
        <ul class="right">
          ...
          <li class="active"><a href="orders.php">Pesananku</a></li>
          ...
          if(isset($_SESSION['username'])){
            ...
            echo '<li><a href="login.php">Loginn</a></li>';
        ...
        <?php
          ...
          if($result) {
            while($obj = $result->fetch_object()) {
              ...
              echo '<p><strong>Tanggal Belanja</strong>: '.$obj->date.'</p>';
              echo '<p><strong>Kode Produk</strong>: '.$obj->product_code.'</p>';
              echo '<p><strong>Nama Produk</strong>: '.$obj->product_name.'</p>';
              echo '<p><strong>Harga (Per 100g)</strong>: '.$obj->price.'</p>';
              echo '<p><strong>Tersedia</strong>: '.$obj->units.'</p>';
